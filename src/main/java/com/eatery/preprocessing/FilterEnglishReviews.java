    ...
    public static void splitJson(String json) {
        ...
        try {
            ...
            if (!matcher.find()) {
                ...
                isEnglish = languageDetect.isReviewInEnglish(review); //checking whether review is english or not
            }
