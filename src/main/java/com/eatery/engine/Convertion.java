...
public class Convertion {
    ...
    final static String foodList = "/home/bruntha/Documents/FYP/Data/Foodlist/Foodnames.txt";

    final static String foodListConverted = "/home/bruntha/Documents/FYP/Data/Foodlist/Foodnames_NLP.txt";
    ...
    public static void main(String[] args) {
        ...
        convertion.convertFoodNamesToNLP(foodList);

    }

    public void convertToNLP() {
        try {
            loadAllTags();
    ...
    public void convertFoodNamesToNLP(String file) {
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                writePrintStream("<START:F_FoodItem> " + line.trim() + " <END>", true, foodListConverted);
            }
...
//        }
    ...
    private void loadAllTagsByNumber() throws IOException {
        File fileAnnotation = new File(filePathAnnotation);
        FileReader fr = new FileReader(fileAnnotation);
        BufferedReader br = new BufferedReader(fr);
        String line;
    ...
    private void convertBratToOpennlp() throws IOException {
...
//                    currentIndex = line.indexOf(tags.get(i).getWord(), currentIndex + 1);
            ...
            writePrintStream(removeSpaceWITags(line), true, filePathConverted);
//            System.out.println(line);
        }
        br.close();
        fr.close();
    ...
    private void convertBratToOpennlpByNumber() throws IOException {
        File fileAnnotation = new File(filePathToBeConverted);
        FileReader fr = new FileReader(fileAnnotation);
        BufferedReader br = new BufferedReader(fr);
        String lineRead;
        ...
        while ((lineRead = br.readLine()) != null) {
            ...
            for (int i = 0; i < tagsNumbers.size(); i++) {
                if (tagsNumbers.get(i).getStartIndex() >= totalIndex && tagsNumbers.get(i).getEndIndex() <= totalIndex + lineLenght) {
                    ...
                    writePrintStream(newLine, true, filePathConverted);
                }
            }
    ...
    public String removeInnerTags(String line) {
...
//        boolean taggedCorrectly;
    ...
    public String removeSpaceWITags(String line) {
    ...
    public void writePrintStream(String line, boolean isNextReview, String filePathConverted) {
